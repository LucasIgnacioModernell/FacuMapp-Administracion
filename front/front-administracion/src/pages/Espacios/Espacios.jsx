...
export default function Espacios() {
  ...
  // NUEVO: Estado para saber qué zona se está tocando
  ...
  const COLORS = {
    ...
    zonaDefault: "#e0e0e0",
    zonaStroke: "#cccccc",
    zonaHover: "#ffc107", // Ahora sí se usará este color
  };
                ...
                <div key={esp.id} className="custom-card">
                  ...
                  <div className="card-body">
                    ...
                    <Link
                      ...
                      className="btn btn-warning text-white btn-action"
                    >
                      Editar
                    </Link>
                  </div>
        ...
        <div className="col-lg-5">
          <div className="card p-3 border-0">
            ...
            <div className="map-container">
              ...
              >
                <g id="Group 1">
                  {/* Generación dinámica de zonas clickeables */}
                  {ZONES.map((zone) => {
                    ...
                    // Lógica para determinar el color actual
